...
Il faut indiquer les stages ou les formations qui ont un lien avec votre projet de diplôme actuel.<br/> Si vous n'êtes pas sûr de vous, remplissez cette rubrique au maximum, nous ferons le tri !<br/> Rappelez-vous, ce n'est pas une condition pour valider votre demande, ces renseignements nous aident simplement à mieux vous connaitre. La seule condition requise pour démarrer votre projet reste d'avoir 1 an d'expérience.      </div>
