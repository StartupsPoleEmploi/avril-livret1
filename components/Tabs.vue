...
export default {
  computed: {
    ...
    formationIsOk(){
      let educationState = this.$store.state.education;
      return
        educationState.relatedDegrees.length &&
        educationState.trainings.length &&
        educationState.latestCourseLevel &&
        educationState.latestDegree;
    },
    identityIsOk(){
      return false;
    },
